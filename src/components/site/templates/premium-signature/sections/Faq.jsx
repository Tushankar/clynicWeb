/**
 * FAQ — Rebuilt with Maven Clinic warm cream background,
 * clean forest-green borders, and toggleable icon highlights.
 */
  ...
  return (
    <div
      className={cx(
        ...
        open
          ? 'border-emerald-600/20 shadow-[0_2px_6px_rgba(10,27,58,0.02),0_20px_44px_-18px_rgba(0,90,54,0.08)]'
          : 'border-slate-200/70 shadow-[0_1px_2px_rgba(10,27,58,0.02)] hover:border-slate-300'
      )}
    >
      <button
        type="button"
